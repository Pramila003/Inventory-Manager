...
def update_product(products,suppliers):
    product_id=int(input("enter the product Id is which you want to update: "))
    product=find_product_by_id(products,product_id)
    if product is  None:
        ...
        if choice==1:
            ...
            print("current supplier_id: ",product.supplier_id)
            ...
            print("current reorder_level: ",product.reorder_level)
...
def restock_product(products):
    ...
    if product is None:
        ...
        if choice==1:
            ...
            new_product_quantity=product.update_stock(amount)
